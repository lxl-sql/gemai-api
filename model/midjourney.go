...
type Midjourney struct {
	...
	WalletQuotaConsumed     int    `json:"wallet_quota_consumed" gorm:"type:int;default:0;column:wallet_quota_consumed"`
	WalletGiftQuotaConsumed int    `json:"wallet_gift_quota_consumed" gorm:"type:int;default:0;column:wallet_gift_quota_consumed"`
	WalletTransactionIds    string `json:"wallet_transaction_ids" gorm:"type:text;column:wallet_transaction_ids"`
