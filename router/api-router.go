	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/quota-transactions", controller.GetSelfQuotaTransactions)
		...
		usageRoute.Use(middleware.CORS(), middleware.CriticalRateLimit())
		{
			...
			{
				tokenUsageRoute.GET("/", middleware.DisableCache(), controller.GetTokenUsage)
			}
		}
		...
		logRoute.GET("/stat", middleware.AdminAuth(), middleware.SearchRateLimit(), controller.GetLogsStat)
		logRoute.GET("/self/stat", middleware.UserAuth(), middleware.SearchRateLimit(), controller.GetLogsSelfStat)
		logRoute.GET("/channel_affinity_usage_cache", middleware.AdminAuth(), controller.GetChannelAffinityUsageCacheStats)
		logRoute.GET("/search", middleware.AdminAuth(), controller.SearchAllLogs)
		logRoute.GET("/self", middleware.UserAuth(), controller.GetUserLogs)
		logRoute.GET("/self/search", middleware.UserAuth(), middleware.SearchRateLimit(), controller.SearchUserLogs)

		quotaTransactionRoute := apiRouter.Group("/quota-transactions")
		{
			quotaTransactionRoute.GET("/", middleware.AdminAuth(), controller.GetAllQuotaTransactions)
			quotaTransactionRoute.GET("/self", middleware.UserAuth(), controller.GetSelfQuotaTransactions)
		}
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/billing-settlement/requeue", controller.RequeueManualBillingSettlement)
