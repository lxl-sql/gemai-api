...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"custom_script":               common.CustomScript,
		...
		"token_usage_source_enabled":  system_setting.TokenUsageSourceUIEnabled(),
	}
...
func SendEmailVerification(c *gin.Context) {
	email, err := common.ValidateEmailPolicy(c.Query("email"))
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
	...
	content := common.TranslateMessage(c, i18n.MsgUserEmailVerificationContent, map[string]any{
		"SystemName": common.SystemName,
		"Code":       code,
